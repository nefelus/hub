...
(function () {
    ...
    var QueueLimits = function QueueLimits() {
      ...
      this.resolveLimits = function(opt) {
        ...
        // SESSIONS
        candidateOpts = [{'resourceType' : 'S', 'resourceId' : 0}, // Total sessions
                         {'company' : c, 'resourceType' : 'S', 'resourceId' : 0}, // Total company sessions
                         {'company' : c, 'user' : u, 'resourceType' : 'S', 'resourceId' : 0}, // Total user sessions
                         {'company' : c, 'project' : p, 'resourceType' : 'S', 'resourceId' : 0}, // Total project sessions
                         {'company' : c, 'user' : u, 'project' : p, 'resourceType' : 'S', 'resourceId' : 0}, // Total project/user sessions
                        ];
